...
class PenggunaanController extends Controller
{
    ...
    public function penggunaan()
    {
        ...
        return view('admin.penggunaan.penggunaan', compact('penggunaan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //tambah data produk
        return redirect()->route('admin.penggunaan.penggunaan');
    }
    ...
    {
        $pelanggan = Pelanggan::all();
        return view('admin.penggunaan.edit', compact('id', 'pelanggan'));
    }
    ...
    {
        $id->delete();
        return redirect()->route('admin.penggunaan.penggunaan')->with('success', 'Data berhasil dihapus');
    }
}
