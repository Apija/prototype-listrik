...
class PetugasPembayaranController extends Controller
{
    ...
    public function pembayaran()
    {
        ...
        return view('petugas.pembayaran.pembayaran', compact('pembayaran'));
    }
    ...
    public function create()
    {
        ...
        return view('petugas.pembayaran.create', compact('tagihan', 'pembayaran', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('petugas.pembayaran.pembayaran')
